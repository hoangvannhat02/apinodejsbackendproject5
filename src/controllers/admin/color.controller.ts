...
export class ColorController{
    ...
    async get(req:Request,res:Response): Promise<void>{
        try{
            const results = await this.colorservice.getdata();
            if(results){
                res.json(results);
            }
            else{
    ...
    async getdatabyid(req:Request,res:Response): Promise<void>{
        try{
            const results = await this.colorservice.getdatabyid(req.params.id);      
            if(results){
                res.json(results);
            }
            else{
    ...
    async create(req:Request,res:Response):Promise<void>{
        try {
            const data = req.body as {TenMau: any};           
            const results = await this.colorservice.create(data);
            if(results){
    ...
    async delete(req:Request,res:Response):Promise<void>{
        try {
            const results = await this.colorservice.delete(req.params.id);
            if(results){
    ...
    async update(req:Request,res:Response):Promise<void>{
        try {
            ...
            const data = req.body as {MaMau:any,TenMau: any};          
            const results = await this.colorservice.update(data);
            if(results){
    ...
    async search(req:Request,res:Response):Promise<void>{
        try {                        
            ...
            const results = await this.colorservice.search(data);            
            if(results){
                res.json(results)
            }
            else{
