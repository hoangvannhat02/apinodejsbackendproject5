...
import { transportService } from "../../services/admin/transport.service";
...
export class TransportController{
    ...
    async get(req:Request,res:Response): Promise<void>{
        try{
            const results = await this.transportservice.getdata();
            if(results){
                res.json(results);
            }
            else{
    ...
    async getdatabyid(req:Request,res:Response): Promise<void>{
        try{
            const results = await this.transportservice.getdatabyid(req.params.id);      
            if(results){
                res.json(results);
            }
            else{
    ...
    async create(req:Request,res:Response):Promise<void>{
        try {
            ...
            const results = await this.transportservice.create(data);
            if(results){
    ...
    async delete(req:Request,res:Response):Promise<void>{
        try {
            const results = await this.transportservice.delete(req.params.id);
            if(results){
    ...
    async update(req:Request,res:Response):Promise<void>{
        try {            
            ...
            const results = await this.transportservice.update(data);
            if(results){
    ...
    async search(req:Request,res:Response):Promise<void>{
        try {                        
            ...
            const results = await this.transportservice.search(data);            
            if(results){
                res.json(results)
            }
            else{
